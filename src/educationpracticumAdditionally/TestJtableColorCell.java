...
// ---- Это тестовый класс что он тут делает? ----
public class TestJtableColorCell extends JFrame {
   public TestJtableColorCell() {
   ...
   public static void main(String[] args) {
      TestJtableColorCell main = new TestJtableColorCell();
      main.pack();
